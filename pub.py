    ...
    def abstract_with_annotations_dict(self, full=True):
        ...
        if self.abstract_structured:
            ...
            sections = [
                ...
                {"text": summary_text, "heading": "SUMMARY", "section_split_source": "automated", "summary": True, "original_start":len(background_text)+0, "original_end":len(self.abstract_text)}
            ]
